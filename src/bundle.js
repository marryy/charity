...
/******/ 	var hotCurrentHash = "a587f428e13604a986e8"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports) {
	...
	angular.module('charity', ['ngComponentRouter', 'ngResource', 'restService']);
...
/***/ function(module, exports) {
	...
	angular.module('charity').component('appCmp', {
	  ...
	  $routeConfig: [{ path: '/', component: 'homepageCmp', name: 'Homepage', useAsDefault: true }, { path: '/causes', component: 'causesCmp', name: 'Causes' }, { path: '/events/...', component: 'eventsCmp', name: 'Events' }]
	});
...
/***/ function(module, exports) {
	...
	angular.module('charity').component('homepageCmp', {
	  templateUrl: 'components/homepage-cmp/homepage-cmp.html'
	});
